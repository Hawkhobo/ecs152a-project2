...
# Read top sites
with open("part2/top-1m.csv", newline = '') as file: 
...
with open("failed_list.csv", "w", newLine = '') as csvf:
    csv.writer(csvf).writerows(failed)
